...
export CONFIG_YAML="examples/modelExtensions/CoT/configs/qwen35_gr00t_arx_box_CoT_v2_q32_nodepthcond.yaml"
export RUN_ID="${RUN_ID:-qwen35_gr00t_arx_box_CoT_v2_q32_nodepthcond}"
