...
def test_arx_box_entrypoint_preserves_the_dual_arm_30_step_contract():
    config_path = (
        ROOT
        / "examples/modelExtensions/CoT/configs"
    ...
    assert cfg.framework.name == "QwenCoTv2_arx"
    assert cfg.framework.action_model.action_horizon == 30
    assert cfg.datasets.vla_data.cot_geometry.action_horizon == 30
    assert cfg.framework.geometry.uvd_num_points == 11
